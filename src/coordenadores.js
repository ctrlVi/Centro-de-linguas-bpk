const urlCoordenador= "https://951p4oju.api.sanity.io/v2021-10-21/data/query/production?query=*%5B_type+%3D%3D+%22coordinatorCard%22%5D%7B%0A++%22id%22%3A+_id%2C%0A++%22name%22%3A+name%2C%0A++%22gender%22%3A+gender%2C%0A++%22img%22%3A+coordinatorImg.asset-%3Eurl%0A%7D";
...
async function getCoordenadores() {
    ...
    const response = await fetch(urlCoordenador);
